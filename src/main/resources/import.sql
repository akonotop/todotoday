...
insert into user (username, enabled, password,role_id) values ('user',true,'$2a$10$DRQjW.42ujut3tlGSNAjh.Jm4XC1yJaa5Q4PAPqY8KqMhg/63n31e',1);
insert into user (username, enabled, password,role_id) values ('user2',true,'$2a$10$DRQjW.42ujut3tlGSNAjh.Jm4XC1yJaa5Q4PAPqY8KqMhg/63n31e',1);
